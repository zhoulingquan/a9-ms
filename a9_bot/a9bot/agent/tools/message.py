...
from a9bot.agent.tools.path_utils import resolve_workspace_path
from a9bot.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from a9bot.bus.events import OutboundMessage
from a9bot.config.paths import get_workspace_path
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from a9bot.utils.helpers import strip_think
