...
from a9bot.agent.tools.file_state import FileStates, _hash_file, current_file_states
...
from a9bot.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from a9bot.utils.document import extract_text
