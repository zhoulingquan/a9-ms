"""JSON Schema fragment types: all subclass :class:`~a9bot.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~a9bot.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~a9bot.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~a9bot.agent.tools.base.Schema`.
...
from a9bot.agent.tools.base import Schema
