...
from a9bot.agent.hook import AgentHook, AgentHookContext
...
from a9bot.utils.file_edit_events import (
...
from a9bot.utils.progress_events import (
    invoke_file_edit_progress,
    on_progress_accepts_file_edit_events,
)
from a9bot.utils.prompt_templates import render_template
from a9bot.utils.runtime import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set A9BOT_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("A9BOT_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # (A9BOT_STREAM_IDLE_TIMEOUT_S). Do not also apply the outer wall-clock
        # LLM timeout here, or healthy long reasoning streams can be killed just
        # because total elapsed time exceeded A9BOT_LLM_TIMEOUT_S.
