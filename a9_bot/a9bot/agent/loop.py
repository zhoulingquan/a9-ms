...
from a9bot.agent import context as agent_context
from a9bot.agent import model_presets as preset_helpers
from a9bot.agent.autocompact import AutoCompact
from a9bot.agent.context import ContextBuilder
from a9bot.agent.hook import AgentHook, CompositeHook
from a9bot.agent.memory import Consolidator, Dream
from a9bot.agent.progress_hook import AgentProgressHook
from a9bot.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
from a9bot.agent.subagent import SubagentManager
from a9bot.agent.tools.file_state import FileStateStore, bind_file_states, reset_file_states
from a9bot.agent.tools.message import MessageTool
from a9bot.agent.tools.registry import ToolRegistry
from a9bot.agent.tools.self import MyTool
from a9bot.bus.events import InboundMessage, OutboundMessage
from a9bot.bus.queue import MessageBus
from a9bot.command import CommandContext, CommandRouter, register_builtin_commands
from a9bot.config.schema import AgentDefaults, ModelPresetConfig
from a9bot.providers.base import LLMProvider
from a9bot.providers.factory import ProviderSnapshot
from a9bot.session.goal_state import (
    runner_wall_llm_timeout_s,
)
from a9bot.session.manager import Session, SessionManager
from a9bot.session.webui_turns import (
    WebuiTurnCoordinator,
    build_bus_progress_callback,
    mark_webui_session,
)
from a9bot.utils.document import extract_documents
from a9bot.utils.helpers import image_placeholder_text
from a9bot.utils.helpers import truncate_text as truncate_text_fn
from a9bot.utils.image_generation_intent import image_generation_prompt
from a9bot.utils.llm_runtime import LLMRuntime
from a9bot.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from a9bot.config.schema import (
        ChannelsConfig,
        ProviderConfig,
        ToolsConfig,
    )
...
class AgentLoop:
    ...
    def __init__(
        ...
        from a9bot.config.schema import ToolsConfig
        ...
        self.exec_config = type('obj', (object,), {'enable': False, 'sandbox': None})()
        self._image_generation_provider_configs = {}
        if (
        ...
        # A9BOT_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("A9BOT_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from a9bot.providers.factory import make_provider
    ...
    def _register_default_tools(self) -> None:
        ...
        allowed_tools = {str(item) for item in self.tools_config.enabled_tools}
        my_tool_allowed = "*" in allowed_tools or "my" in allowed_tools
        if self.tools_config.my.enable and my_tool_allowed:
            self.tools.register(
    ...
    def _set_tool_context(
        ...
        from a9bot.agent.tools.context import ContextAware, RequestContext
        ...
        *on_stream_end(resuming)*: called when a streaming session finishes.
        ...
        try:
            result = await self.runner.run(AgentRunSpec(
                ...
                # Sustained goals may legitimately exceed A9BOT_LLM_TIMEOUT_S; idle stall
                # is still capped by A9BOT_STREAM_IDLE_TIMEOUT_S in streaming providers.
