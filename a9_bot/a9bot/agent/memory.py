...
from a9bot.agent.runner import AgentRunner, AgentRunSpec
from a9bot.agent.tools.registry import ToolRegistry
from a9bot.session.manager import Session
from a9bot.utils.gitstore import GitStore
...
class Dream:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        from a9bot.agent.skills import BUILTIN_SKILLS_DIR
        from a9bot.agent.tools.file_state import FileStates
        from a9bot.agent.tools.filesystem import EditFileTool, ReadFileTool, WriteFileTool
